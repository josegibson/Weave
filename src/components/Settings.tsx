...
export default function Settings({ options, onChange, darkMode = false }: SettingsProps) {
    ...
    <div className="settings-panel" style={{
      ...
      <div 
        ...
        style={{
          ...
          alignItems: 'center',
          padding: '14px 16px',
          backgroundColor: darkMode ? 'rgba(0, 91, 97, 0.7)' : theme.colors.midnightTeal,
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <h3 style={{ margin: 0, fontWeight: 600 }}>Output Settings</h3>
        </div>
        <span style={{ 
          fontSize: '10px', 
        ...
        <div className="setting-item">
          ...
          <div style={{ display: 'flex', gap: theme.spacing.sm }}>
            <div style={{ 
              ...
              color: darkMode ? 'rgba(255, 255, 255, 0.7)' : theme.colors.darkGray,
              display: 'flex',
              alignItems: 'center',
              minHeight: '38px'
            }}>
              {options.outputDirectory ? (
                ...
                <span style={{ opacity: 0.6, fontStyle: 'italic' }}>No directory selected</span>
              )}
            </div>
            <button 
              ...
              style={{
                backgroundColor: darkMode ? 'rgba(255, 191, 0, 0.8)' : theme.colors.amber,
          ...
          {!options.outputDirectory && (
            <div style={{ 
              marginTop: '8px', 
              fontSize: '0.8rem',
              color: darkMode ? 'rgba(255, 191, 0, 0.9)' : theme.colors.amber
            }}>
